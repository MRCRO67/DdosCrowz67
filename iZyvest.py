...
def helptext ():
        ...
        print "   -p (port)"
        print "Version 1.2 (Avaliable version 1.4 )"
        print "===============NEWS==============="
        print "This Tool is still BETA so many BUGS here!"
        print "Avaliable version 1.4 contact Amon#0997"
        print "iZyvest#7665 Personal Tools"
        print "============UPDATE================"
...
def sender (num):
        ...
        col()
        print "[IZYVEST] CONNECTING! %d " % num
